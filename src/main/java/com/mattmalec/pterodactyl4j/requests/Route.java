...
public class Route {
	...
	public static class Schedules {
		...
		public static final Route DELETE_TASK			= new Route(DELETE, CLIENT_PREFIX + "servers/{server_id}/schedules/{schedule_id}/tasks/{identifier}", "server_id", "schedule_id", "identifier");
